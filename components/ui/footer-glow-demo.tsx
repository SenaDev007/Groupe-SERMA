    ...
    <footer className="relative z-10 mt-8 w-full overflow-hidden pt-16 pb-8">
      <style jsx global>{`
        .glass {
          ...
          background: radial-gradient(circle, rgba(255, 255, 255, 0.06) 0%, rgba(17, 32, 70, 0.3) 60%, rgba(8, 14, 32, 1) 100%);
      ...
      <div className="pointer-events-none absolute top-0 left-1/2 z-0 h-full w-full -translate-x-1/2 select-none">
        <div className="absolute -top-32 left-1/4 h-72 w-72 rounded-full bg-orange-logo/15 blur-3xl"></div>
        <div className="absolute right-1/4 -bottom-24 h-80 w-80 rounded-full bg-orange-logo/15 blur-3xl"></div>
      </div>
      <div className="glass relative mx-auto flex max-w-6xl flex-col items-center gap-8 rounded-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
        <div className="flex flex-col items-center md:items-start">
          <a href="#" className="mb-4 flex items-center gap-2">
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-orange-logo to-orange-sature text-2xl font-extrabold text-white shadow-md">
              <svg
            ...
            <span className="bg-gradient-to-br from-orange-logo to-orange-sature bg-clip-text text-xl font-semibold tracking-tight text-transparent">
              Mvpblocks
            </span>
          </a>
          <p className="text-slate-300 mb-6 max-w-xs text-center text-sm md:text-left">
          ...
          <div className="mt-2 flex gap-3 text-orange-logo">
            <a
              href="#"
              aria-label="Twitter"
        ...
        <nav className="flex w-full flex-col gap-9 text-center md:w-auto md:flex-row md:justify-end md:text-left">
          <div>
            <div className="mb-3 text-xs font-semibold tracking-widest text-orange-logo uppercase">
              Product
            </div>
      ...
      <div className="text-slate-400 relative z-10 mt-10 text-center text-xs">
